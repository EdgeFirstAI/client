...
//!   (default: 3)
//! - `MAX_TASKS`: Maximum concurrent upload/download tasks
//!   (default: half of CPU cores, min 2, max 8). Lower values (2-8) work better
//!   for large files to avoid timeouts. Higher values (16-32) are better for
//!   many small files.
//!
