...
public protocol ClientProtocol: AnyObject, Sendable {
     ...
     */
    func jobRun(appName: String, jobName: String, env: [String: String], data: [String: Parameter]) throws  -> Job
     ...
     */
    func jobRunAsync(appName: String, jobName: String, env: [String: String], data: [String: Parameter]) async throws  -> Job
...
open func experimentsAsync(projectId: ProjectId, name: String?)async throws  -> [Experiment]  {
     ...
     * task ID for calling `task_info`.
     */
open func jobRun(appName: String, jobName: String, env: [String: String], data: [String: Parameter])throws  -> Job  {
    return try  FfiConverterTypeJob_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
     ...
     * task ID for calling `task_info_async`.
     */
open func jobRunAsync(appName: String, jobName: String, env: [String: String], data: [String: Parameter])async throws  -> Job  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_edgefirst_client_fn_method_client_job_run_async(
                    self.uniffiCloneHandle(),
                    FfiConverterString.lower(appName),FfiConverterString.lower(jobName),FfiConverterDictionaryStringString.lower(env),FfiConverterDictionaryStringTypeParameter.lower(data)
                )
            },
            pollFunc: ffi_edgefirst_client_rust_future_poll_rust_buffer,
            completeFunc: ffi_edgefirst_client_rust_future_complete_rust_buffer,
     ...
     * Request a running job to stop.
     */
open func jobStop(taskId: TaskId)throws   {try rustCallWithError(FfiConverterTypeClientError_lift) {
...
open func jobs(name: String?)throws  -> [Job]  {
    return try  FfiConverterSequenceTypeJob.lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
open func validationSession(id: ValidationSessionId)throws  -> ValidationSession  {
    return try  FfiConverterTypeValidationSession_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public protocol TaskInfoProtocol: AnyObject, Sendable {
     ...
     */
    func addChart(client: Client, group: String, name: String, data: Parameter, params: Parameter?) throws 
    
    /**
     * Adds (or overwrites) a chart under `(group, name)` for this task (async).
     */
    func addChartAsync(client: Client, group: String, name: String, data: Parameter, params: Parameter?) async throws 
     ...
     */
    func downloadData(client: Client, file: String, outputPath: String, folder: String?, progress: ProgressCallback?) throws 
     ...
     * events during the download.  Pass `None` to suppress progress reporting.
     */
    func downloadDataAsync(client: Client, file: String, outputPath: String, folder: String?, progress: ProgressCallback?) async throws 
     ...
     * events during the upload.  Pass `None` to suppress progress reporting.
     */
    func uploadDataAsync(client: Client, path: String, folder: String?, progress: ProgressCallback?) async throws 
...
open class TaskInfo: TaskInfoProtocol, @unchecked Sendable {
     ...
     * Adds (or overwrites) a chart under `(group, name)` for this task.
     */
open func addChart(client: Client, group: String, name: String, data: Parameter, params: Parameter?)throws   {try rustCallWithError(FfiConverterTypeClientError_lift) {
     ...
     * Adds (or overwrites) a chart under `(group, name)` for this task (async).
     */
open func addChartAsync(client: Client, group: String, name: String, data: Parameter, params: Parameter?)async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_edgefirst_client_fn_method_taskinfo_add_chart_async(
                    self.uniffiCloneHandle(),
                    FfiConverterTypeClient_lower(client),FfiConverterString.lower(group),FfiConverterString.lower(name),FfiConverterTypeParameter_lower(data),FfiConverterOptionTypeParameter.lower(params)
                )
            },
            pollFunc: ffi_edgefirst_client_rust_future_poll_void,
            completeFunc: ffi_edgefirst_client_rust_future_complete_void,
...
open func dataList(client: Client)throws  -> TaskDataList  {
    return try  FfiConverterTypeTaskDataList_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
open func description() -> String  {
     ...
     * events during the download.  Pass `None` to suppress progress reporting.
     */
open func downloadData(client: Client, file: String, outputPath: String, folder: String?, progress: ProgressCallback?)throws   {try rustCallWithError(FfiConverterTypeClientError_lift) {
     ...
     * events during the download.  Pass `None` to suppress progress reporting.
     */
open func downloadDataAsync(client: Client, file: String, outputPath: String, folder: String?, progress: ProgressCallback?)async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_edgefirst_client_fn_method_taskinfo_download_data_async(
                    self.uniffiCloneHandle(),
                    FfiConverterTypeClient_lower(client),FfiConverterString.lower(file),FfiConverterString.lower(outputPath),FfiConverterOptionString.lower(folder),FfiConverterOptionCallbackInterfaceProgressCallback.lower(progress)
                )
            },
            pollFunc: ffi_edgefirst_client_rust_future_poll_void,
            completeFunc: ffi_edgefirst_client_rust_future_complete_void,
...
open func getChart(client: Client, group: String, name: String)throws  -> Parameter  {
    return try  FfiConverterTypeParameter_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
open func getChartAsync(client: Client, group: String, name: String)async throws  -> Parameter  {
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_edgefirst_client_fn_method_taskinfo_get_chart_async(
                    self.uniffiCloneHandle(),
                    FfiConverterTypeClient_lower(client),FfiConverterString.lower(group),FfiConverterString.lower(name)
                )
            },
            pollFunc: ffi_edgefirst_client_rust_future_poll_rust_buffer,
            completeFunc: ffi_edgefirst_client_rust_future_complete_rust_buffer,
     ...
     */
open func id() -> TaskId  {
    return try!  FfiConverterTypeTaskId_lift(try! rustCall() {
...
open func projectId() -> ProjectId?  {
    return try!  FfiConverterOptionTypeProjectId.lift(try! rustCall() {
...
open func status() -> String?  {
     ...
     * events during the upload.  Pass `None` to suppress progress reporting.
     */
open func uploadData(client: Client, path: String, folder: String?, progress: ProgressCallback?)throws   {try rustCallWithError(FfiConverterTypeClientError_lift) {
     ...
     * events during the upload.  Pass `None` to suppress progress reporting.
     */
open func uploadDataAsync(client: Client, path: String, folder: String?, progress: ProgressCallback?)async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_edgefirst_client_fn_method_taskinfo_upload_data_async(
                    self.uniffiCloneHandle(),
                    FfiConverterTypeClient_lower(client),FfiConverterString.lower(path),FfiConverterOptionString.lower(folder),FfiConverterOptionCallbackInterfaceProgressCallback.lower(progress)
                )
            },
            pollFunc: ffi_edgefirst_client_rust_future_poll_void,
            completeFunc: ffi_edgefirst_client_rust_future_complete_void,
...
public protocol ValidationSessionProtocol: AnyObject, Sendable {
     ...
     * events during the download.  Pass `None` to suppress progress reporting.
     */
    func downloadData(client: Client, filename: String, outputPath: String, progress: ProgressCallback?) throws 
     ...
     * events during the download.  Pass `None` to suppress progress reporting.
     */
    func downloadDataAsync(client: Client, filename: String, outputPath: String, progress: ProgressCallback?) async throws 
     ...
     * events during the upload.  Pass `None` to suppress progress reporting.
     */
    func uploadData(client: Client, files: [FileEntry], folder: String?, progress: ProgressCallback?) throws 
     ...
     * events during the upload.  Pass `None` to suppress progress reporting.
     */
    func uploadDataAsync(client: Client, files: [FileEntry], folder: String?, progress: ProgressCallback?) async throws 
...
open func annotationSetId() -> AnnotationSetId  {
    return try!  FfiConverterTypeAnnotationSetId_lift(try! rustCall() {
...
open func dataList(client: Client)throws  -> [String]  {
    return try  FfiConverterSequenceString.lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
open func datasetId() -> DatasetId  {
    return try!  FfiConverterTypeDatasetId_lift(try! rustCall() {
...
open func description() -> String  {
     ...
     * events during the download.  Pass `None` to suppress progress reporting.
     */
open func downloadData(client: Client, filename: String, outputPath: String, progress: ProgressCallback?)throws   {try rustCallWithError(FfiConverterTypeClientError_lift) {
     ...
     * events during the download.  Pass `None` to suppress progress reporting.
     */
open func downloadDataAsync(client: Client, filename: String, outputPath: String, progress: ProgressCallback?)async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_edgefirst_client_fn_method_validationsession_download_data_async(
                    self.uniffiCloneHandle(),
                    FfiConverterTypeClient_lower(client),FfiConverterString.lower(filename),FfiConverterString.lower(outputPath),FfiConverterOptionCallbackInterfaceProgressCallback.lower(progress)
                )
            },
            pollFunc: ffi_edgefirst_client_rust_future_poll_void,
            completeFunc: ffi_edgefirst_client_rust_future_complete_void,
...
open func experimentId() -> ExperimentId  {
    return try!  FfiConverterTypeExperimentId_lift(try! rustCall() {
...
open func id() -> ValidationSessionId  {
    return try!  FfiConverterTypeValidationSessionId_lift(try! rustCall() {
...
open func trainingSessionId() -> TrainingSessionId  {
    return try!  FfiConverterTypeTrainingSessionId_lift(try! rustCall() {
     ...
     * events during the upload.  Pass `None` to suppress progress reporting.
     */
open func uploadData(client: Client, files: [FileEntry], folder: String?, progress: ProgressCallback?)throws   {try rustCallWithError(FfiConverterTypeClientError_lift) {
     ...
     * events during the upload.  Pass `None` to suppress progress reporting.
     */
open func uploadDataAsync(client: Client, files: [FileEntry], folder: String?, progress: ProgressCallback?)async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_edgefirst_client_fn_method_validationsession_upload_data_async(
                    self.uniffiCloneHandle(),
                    FfiConverterTypeClient_lower(client),FfiConverterSequenceTypeFileEntry.lower(files),FfiConverterOptionString.lower(folder),FfiConverterOptionCallbackInterfaceProgressCallback.lower(progress)
                )
            },
            pollFunc: ffi_edgefirst_client_rust_future_poll_void,
            completeFunc: ffi_edgefirst_client_rust_future_complete_void,
...
public struct FfiConverterTypeClientError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ClientError {
        ...
        case 7: return .TaskNotFound(
            taskId: try FfiConverterString.read(from: &buf)
            )
        case 8: return .PermissionDenied(
            message: try FfiConverterString.read(from: &buf)
            )
        case 9: return .PayloadTooLarge(
            message: try FfiConverterString.read(from: &buf)
            )
...
private func uniffiCallbackInitProgressCallback() {
    uniffi_edgefirst_client_fn_init_callback_vtable_progresscallback(UniffiCallbackInterfaceProgressCallback.vtablePtr)
}
...
fileprivate struct UniffiCallbackInterfaceTokenStorage {
    ...
    // Rust stores this pointer for future callback invocations, so it must live
    // for the process lifetime (not just for the init function call).
    static let vtablePtr: UnsafePointer<UniffiVTableCallbackInterfaceTokenStorage> = {
        let ptr = UnsafeMutablePointer<UniffiVTableCallbackInterfaceTokenStorage>.allocate(capacity: 1)
        ptr.initialize(to: vtable)
        return UnsafePointer(ptr)
    }()
}
...
private func uniffiCallbackInitTokenStorage() {
    uniffi_edgefirst_client_fn_init_callback_vtable_tokenstorage(UniffiCallbackInterfaceTokenStorage.vtablePtr)
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypePolygon: FfiConverterRustBuffer {
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeTiming: FfiConverterRustBuffer {
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeParameter: FfiConverterRustBuffer {
    typealias SwiftType = Parameter?
...
public func parseAnnotationSetId(s: String)throws  -> AnnotationSetId  {
    return try  FfiConverterTypeAnnotationSetId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseAppId(s: String)throws  -> AppId  {
    return try  FfiConverterTypeAppId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseDatasetId(s: String)throws  -> DatasetId  {
    return try  FfiConverterTypeDatasetId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseExperimentId(s: String)throws  -> ExperimentId  {
    return try  FfiConverterTypeExperimentId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseImageId(s: String)throws  -> ImageId  {
    return try  FfiConverterTypeImageId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseOrganizationId(s: String)throws  -> OrganizationId  {
    return try  FfiConverterTypeOrganizationId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseProjectId(s: String)throws  -> ProjectId  {
    return try  FfiConverterTypeProjectId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseSampleId(s: String)throws  -> SampleId  {
    return try  FfiConverterTypeSampleId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseSequenceId(s: String)throws  -> SequenceId  {
    return try  FfiConverterTypeSequenceId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseSnapshotId(s: String)throws  -> SnapshotId  {
    return try  FfiConverterTypeSnapshotId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseTaskId(s: String)throws  -> TaskId  {
    return try  FfiConverterTypeTaskId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseTrainingSessionId(s: String)throws  -> TrainingSessionId  {
    return try  FfiConverterTypeTrainingSessionId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
...
public func parseValidationSessionId(s: String)throws  -> ValidationSessionId  {
    return try  FfiConverterTypeValidationSessionId_lift(try rustCallWithError(FfiConverterTypeClientError_lift) {
 ...
 */
public func validateAnnotation(annotation: Annotation)throws   {try rustCallWithError(FfiConverterTypeClientError_lift) {
