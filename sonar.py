...
def download_report(
    ...
    print(
        f"DEBUG: Final report contains {len(report.get('issues', []))} total issues")
...
if __name__ == "__main__":
    ...
    print(
        f"DEBUG: After conversion - branch={branch}, pull_request_id={pull_request_id}")

    try:
        download_report(host_url, token, org, project,
                        branch, pull_request_id, report_path)
